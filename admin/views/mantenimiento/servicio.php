                                        ...
                                        <form id="frmDatos" name="frmDatos" enctype="multipart/form-data">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="form-group col-sm-4">
                                              ...
                                              alt="Imagen Servicio" class="img-fluid rounded-circle"
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="form-group col-md-12 col-sm-12">
                                              <label for="descripcion_larga" class="label-control">Descripción Larga</label>
                                              <input id="descripcion_larga" type="text" name="descripcion_larga"
