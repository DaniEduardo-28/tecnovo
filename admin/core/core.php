<?php
  ...
  //NUCLEO DE LA APP
  //define('APP_URL','http://clinicaveterinaria.test:8080/admin/');
  define('APP_URL','https://veterinaria.tecnovoperu.com/admin/');
  define('APP_TITLE','PetSpace | Sistema para clínicas veterinarias ');
  define('APP_COPY','Copyright © ' . date('Y',time()) . ' <a href="https://www.tecnovoperu.com" target="_blank">Tecnovo Perú</a>');
  define('APP_VERSION','1.0.0.2');
  define('AUTOR','Zhaúl Valdera');
  define('DESCRIPTION_SYSTEM','Esto es una breve descripción del sistema....');
  define('AUTOR_URL','https://www.tecnovoperu.com');
