...
<html>
  ...
  <body>
                                    ...
                                    <div class="col-md-12" id="panelForm"> <!-- d-none -->
                                      <div class="ser-block block">
                                        <form action="#" method="post" id="frmDatos" name="frmDatos">
                                          ...
                                          <input type="hidden" name="id_tipo_medicamento" id="id_tipo_medicamento" value="">
    ...
    <script src="resources/system/js/pages/configuration/tipomedicamento.js?v=<?=APP_VERSION;?>"></script>
    <script>
      $("#menuconfiguration").addClass('active');
      $("#menutipomedicamento").addClass('active');
    </script>
