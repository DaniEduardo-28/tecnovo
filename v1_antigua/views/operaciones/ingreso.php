                                        ...
                                        <form method="post" id="form_datos">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="form-group col-md-3 col-sm-4">
                                              ...
                                              <input type="text" id="txtNameMetodo" readonly name="txtNameMetodo"
                                              value="" class="form-control">
                                            </div>

                                            <div class="form-group col-md-3 col-sm-4">
                                              <label for="txtFechaOrdenForm" class="label-control">Fecha y Hora</label>
                                              <input type="text" name="txtFechaOrdenForm" id="txtFechaOrdenForm"
                                            ...
                                            <div class="form-group col-md-3 col-sm-4">
                                              ...
                                              <input type="text" id="txtNumDocumento" required autocomplete="off"
                                              name="txtNumDocumento" value="" class="form-control">
                                            </div>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="form-group col-sm-5">
                                              ...
                                              <button type="button" class="btn btn-danger float-right d-none"
                                                id="btnCancelFormVer">
                                                 <span class="fa fa-close"></span> Cancelar
                                              </button>&nbsp;&nbsp;&nbsp;
                                            </div>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-10">
                                          ...
                                          <div class="input-group mb-3">
                                            ...
                                            id="txtBuscarOrden" name="txtBuscarOrden">
                                        ...
                                        <div class="col-sm-2">
                                          ...
                                          <button type="button" name="button" class="btn btn-danger"
                                            id="btnVolverOrden" name="btnVolverOrden">
