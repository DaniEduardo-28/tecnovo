...
<html>
  ...
  <head>
    ...
    <title>Reporte de Accesorios | <?=APP_TITLE;?> </title>
    <style media="screen">
      .pagination {
  ...
  <body>
                              ...
                              <div class="card card-statistics">
                                <div class="card-header">
                                    <div class="card-heading">
                                        <h4 class="card-title">Reporte de Accesorios</h4>
                                    </div>
                                </div>
                                <div class="card-body">
    ...
    <script src="resources/system/js/pages/reportes/vistareporteaccesorios.js?v=<?=APP_VERSION;?>"></script>
    <script>
      $("#menureportes").addClass('active');
      $("#submenureporteaccesorio").addClass('active');
    </script>
