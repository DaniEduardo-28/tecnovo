...
<html>
  ...
  <head>
    ...
    <title>Proveedores | <?=APP_TITLE;?> </title>
    <style media="screen">
      .pagination {
  ...
  <body>
                                        ...
                                        <form id="frmDatos" name="frmDatos" enctype="multipart/form-data">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="form-group col-sm-4">
                                              ...
                                              <br>
                                              <label for="">Logo / Imagen Proveedor</label>
                                              <br>
    ...
    <script src="resources/system/js/pages/mantenimiento/proveedor.js?v=<?=APP_VERSION;?>"></script>
    <script>
