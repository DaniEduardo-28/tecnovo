                        ...
                        <div class="ser-block block">
                          <form id="frmDatos" name="frmDatos" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-xs-12">
                                <label for="nickname" class="label-control" id="lblNickname">Sobrenombre
                                  (Nickname)</label>
                                <input id="nickname" type="text" name="nickname" class="form-control" autocomplete="off"
                                  required data-msg="Campo obligatorio...">
                              </div>
                              ...
                              <div class="form-group col-md-4 col-sm-6">
                                ...
                                <input id="telefono" type="tel" name="telefono" class="form-control" autocomplete="off">
                              </div>
                              ...
                              <div class="form-group col-md-2 col-sm-4" id="lblSexo1">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="sexo" id="rdbM" value="M">
                              ...
                              <div class="form-group col-md-2 col-sm-4" id="lblSexo2">
                                ...
                                <div class="form-check">
                                  <input class="form-check-input" type="radio" name="sexo" id="rdbF" value="F">
