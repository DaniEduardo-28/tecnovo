  ...
  try {
    ...
    foreach ($Resultado["data"] as $key) {
      ...
      if ($access_options[0]['flag_descargar']) {
        $flag_descargar = '<a href="?view=printhistorialclinico&id_mascota=' . $key['id_mascota'] . '" target="_blank" class="btn btn-icon btn-outline-primary btn-round mr-2 mb-2 mb-sm-0 "><i class="ti ti-eye"></i></a>';
      }
      $retorno_array[] =array(
        "num" => "$count",
