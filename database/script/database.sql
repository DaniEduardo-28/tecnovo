...
INSERT INTO `tb_accesorio` (`id_accesorio`, `id_sucursal`, `id_categoria`, `id_unidad_medida`, `name_accesorio`, `descripcion`, `stock`, `stock_minimo`, `precio_compra`, `id_moneda`, `signo_moneda`, `precio_venta`, `flag_igv`, `estado`, `src_imagen`) VALUES
(1, 1, 1, 1, 'Brekkies Pienso para Perros con Buey y Verduras - 15000 gr', '100% Completo y Equilibrado Huesos y dientes fuertes: Con vitaminas y minerales Pelo brillante y piel sana: Con ácidos grasos esenciales Agilidad: Niv', 49, 10, 40.00, 1, 'S/', 50.00, '1', 'activo', 'resources/global/images/accesorios/img-1571244572.png'),
(2, 1, 1, 1, 'KIEM Saco de pienso para Perros Mantenimiento 20 kg, Comida para Perros', 'Pienso para perro compuesto por carnes cereales y productos vegetales pienso para el mantenimiento de tu perro muy barato y de calidad saco de pienso.', 99, 15, 30.00, 2, '$', 50.00, '1', 'activo', 'resources/global/images/accesorios/img-1571244647.png'),
(3, 1, 2, 1, 'Artero Protein Vital, Acondicionador - 100 ml', 'Efecto regenerador inmediato del pelo del perro Aporta suavidad y brillo únicos a tu perro Evita que el pelo se rompa debido a las largas sesiones de', 10, 10, 45.00, 2, '$', 55.00, '1', 'activo', 'resources/global/images/accesorios/img-1571245068.png'),
(4, 1, 2, 1, 'Pro Pooch Gotas oculares para Perros (250 ML)', 'SOLUCION SEGURA NO TÓXICA PARA OJOS - Puede aplicarse 3-4 veces al día o según lo indique su veterinario de confianza. ✔ GMP: fabricado en una instal	', 40, 5, 55.00, 3, '€', 40.00, '1', 'activo', 'resources/global/images/accesorios/img-1571245194.png'),
(5, 1, 3, 1, '10 delicioso Hueso para roer 17 cm - 1000g', '10 sabrosos huesos para morder 17 cm - 1000g Huesos kauk para perros Producto natural hecho de cuero vacuno puro paraperros de tamaño grande y mediano	', 50, 12, 45.00, 1, 'S/', 65.00, '1', 'activo', 'resources/global/images/accesorios/img-1571245228.png'),
(6, 1, 3, 1, 'Hopey \'s kausnack para perros Conejos Orejas con pelo', 'Hopey \'s kausnack natural para perros, conejos, orejas con pelo secado Unique elfutt ermittel para perros, Contenido: 100 g Libre de humo, especias y	', 10, 10, 78.00, 1, 'S/', 89.00, '1', 'activo', 'resources/global/images/accesorios/img-1571245266.png'),
(7, 1, 4, 1, 'Halti Training Lead (6\' 6\")', 'ONTROL Y GUÍA: diseñado para entrenamiento general de obediencia o para caminar, el líder de entrenamiento HALTI es un conductor multifuncional de dob	', 30, 5, 34.00, 1, 'S/', 44.00, '1', 'activo', 'resources/global/images/accesorios/img-1571245997.png'),
(8, 1, 4, 1, 'Company of Animals HALTI Jefe de Entrenamiento, Negro, L', 'CONTROL Y GU?A: dise?ado para entrenamiento general de obediencia o para caminar, el l?der de entrenamiento HALTI es un conductor multifuncional de do	', 100, 10, 5.00, 2, '$', 10.00, '1', 'activo', 'resources/global/images/accesorios/img-1571246033.png');
...
CREATE TABLE `tb_cita` (
  ...
  `estado` enum('registrada','aceptada','cancelada','anulada','atendida') COLLATE utf8mb4_spanish_ci NOT NULL DEFAULT 'registrada'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
INSERT INTO `tb_cita` (`id_cita`, `id_sucursal`, `id_trabajador`, `id_servicio`, `id_mascota`, `fecha_registro`, `fecha_cita`, `fecha_termino`, `sintoma`, `observaciones`, `mensaje_cita`, `estado`) VALUES
(1, 1, 2, 1, 1, '2019-10-16 12:42:52', '2019-10-17 08:00:00', '2019-10-17 09:15:00', 'Necesito realizar el chequeo mensual de mi mascota', NULL, NULL, 'aceptada'),
(2, 1, 2, 1, 1, '2019-10-16 12:44:54', '2019-10-18 10:00:00', '2019-10-18 11:15:00', 'Necesito realizar el chequeo mensual de mi mascota', NULL, NULL, 'aceptada'),
(3, 1, 2, 3, 1, '2019-10-16 12:53:14', '2019-10-19 12:30:00', '2019-10-19 14:30:00', 'Necesito que se realice una operación a mi mascota.', NULL, NULL, 'registrada');
...
(1, 2, 'luisa@gmail.com', '1dd4ecb6f7f0091bc464fee9b9202d59', NULL, '2019-10-16', NULL, 'resources/global/images/persons/img-1571243739.png', 'activo');
...
INSERT INTO `tb_detalle_cita` (`id_detalle`, `id_cita`, `name_servicio`, `motivo`, `sintomas`, `tratamiento`, `vacunas_aplicadas`, `observaciones`, `peso`, `fecha_detalle_cita`) VALUES
(1, 1, 'Medicina preventiva', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 2, 'Medicina preventiva', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 3, 'Cirugía', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `tb_detalle_venta` (`id_detalle`, `id_venta`, `name_tabla`, `cod_producto`, `descripcion`, `cantidad`, `precio_unitario`, `descuento`, `sub_total`, `tipo_igv`, `igv`, `total`) VALUES
(1, 1, 'servicio', '2', 'Consultas', '1.00', '16.949', '0.00', '16.95', '1', '3.05', '20.00'),
(2, 1, 'servicio', '3', 'Cirugía', '1.00', '709.746', '0.00', '709.75', '1', '127.75', '837.50'),
(3, 1, 'servicio', '4', 'Hospitalización', '1.00', '158.898', '0.00', '158.90', '1', '28.60', '187.50'),
(4, 1, 'accesorio', '1', 'Brekkies Pienso para Perros con Buey y Verduras - 15000 gr', '1.00', '42.373', '0.00', '42.37', '1', '7.63', '50.00'),
(5, 1, 'accesorio', '2', 'KIEM Saco de pienso para Perros Mantenimiento 20 kg, Comida para Perros', '1.00', '141.949', '0.00', '141.95', '1', '25.55', '167.50'),
(6, 1, 'medicamento', '3', 'BIOSPORINE 3®', '1.00', '212.924', '0.00', '212.92', '1', '38.33', '251.25'),
(7, 1, 'medicamento', '2', 'AMOXYCOL® WS', '1.00', '50.847', '0.00', '50.85', '1', '9.15', '60.00'),
(8, 1, 'medicamento', '1', 'AGROMYCIN® 11', '1.00', '93.220', '0.00', '93.22', '1', '16.78', '110.00');
...
(4, 'CARNET DE EXTRANJERÍA', '4', 0, 0, 12, 'activo'),
...
INSERT INTO `tb_documento_venta` (`id_documento_venta`, `id_sucursal`, `cod_sunat`, `nombre`, `nombre_corto`, `serie`, `correlativo`, `estado`, `flag_doc_interno`) VALUES
(1, 1, '2', 'BOLETA ELECTRÓNICA', 'BOLETA', 'BPP1', 2, '1', '0'),
(2, 1, '1', 'FACTURA ELECTRÓNICA', 'FACTURA', 'FPP1', 1, '1', '0'),
(3, 1, '-', 'TIKET INTERNO', 'TIKET INTERNO', 'TIK1', 1, '1', '1');
...
(1, 3, '10707623433', 'Veterinaria Mican', 'Clínica Veterinaría Mican', 'Jr. Pedro Remy N 239, San Martín de Porres - Lima - Lima', '916028408', 'informes@veterinariamican.com', 'https://mican.com/', 1, '70762343', 'Jolu', 'Quispe', '916028408', 'jolu@mican.com', 'activo', 'resources/global/images/business_logo/img-1571242080.jpg');
...
INSERT INTO `tb_mascota` (`id_mascota`, `id_cliente`, `id_tipo_mascota`, `nombre`, `raza`, `color`, `peso`, `sexo`, `fecha_nacimiento`, `observaciones`, `estado`, `src_imagen`) VALUES
(1, 1, 1, 'DECAN', 'LABRADOR', 'MARRÓN', '4', 'macho', '2019-09-12', 'Sin Observaciones', 'activo', 'resources/global/images/mascotas/img-1571247077.png');
...
INSERT INTO `tb_mascota_vacuna` (`id_mascota_vacuna`, `id_mascota`, `id_vacuna`, `fecha_minima`, `fecha_maxima`, `fecha_aplicacion`, `flag_vacuna`, `observaciones`, `name_sucursal`, `name_user`) VALUES
(1, 1, 1, '2019-09-24', '2019-10-02', '2019-10-16 12:57:24', 1, 'Sin observaciones', 'LOCAL PRINCIPAL', 'David Moreno'),
(2, 1, 2, '2019-10-12', '2019-10-22', '2019-10-16 13:00:20', 1, 'Sin observaciones', 'LOCAL PRINCIPAL', 'David Moreno'),
(3, 1, 3, '2019-11-21', '2019-12-01', NULL, 0, NULL, '', ''),
(4, 1, 4, '2019-12-21', '2019-12-31', NULL, 0, NULL, '', '');
...
INSERT INTO `tb_medicamento` (`id_medicamento`, `id_sucursal`, `id_tipo_medicamento`, `id_unidad_medida`, `name_medicamento`, `descripcion`, `stock`, `stock_minimo`, `precio_compra`, `id_moneda`, `signo_moneda`, `precio_venta`, `flag_igv`, `estado`, `src_imagen`) VALUES
(1, 1, 1, 1, 'AGROMYCIN® 11', 'Tratamiento de infecciones causadas por microorganismos sensibles a la oxitetraciclina (locales y generalizadas) en todas las especies de animales.	', 99, 5, 100.00, 1, 'S/', 110.00, '1', 'activo', 'resources/global/images/medicamentos/img-1571246151.png'),
(2, 1, 1, 1, 'AMOXYCOL® WS', 'Potente Combinación Antibiótica Betalactámica-Polipéptido de Amplio Espectro	', 3, 10, 50.00, 1, 'S/', 60.00, '1', 'activo', 'resources/global/images/medicamentos/img-1571246250.png'),
(3, 1, 6, 1, 'BIOSPORINE 3®', 'Crema Topical Triple asociación antibiótica topical de amplio espectro	', 53, 4, 65.00, 2, '$', 75.00, '1', 'activo', 'resources/global/images/medicamentos/img-1571246283.png');
...
(106, 'Categorias de Accesorios', 'activo', NULL, 6, NULL),
(107, 'Tipos de Servicios', 'activo', NULL, 7, NULL),
(108, 'Tipos de Mascotas', 'activo', NULL, 8, NULL),
(109, 'Tipos de Medicamentos', 'activo', NULL, 9, NULL),
...
(503, 'Historial Clínico', 'activo', NULL, 0, NULL),
...
(601, 'Ficha de Mascota y Vacunas', 'activo', NULL, 0, NULL),
...
(703, 'Reporte de Accesorios', 'activo', NULL, 0, NULL),
(704, 'Reporte de Medicamentos', 'activo', NULL, 0, NULL),
(705, 'Mostrar Estadísticas', 'activo', NULL, 0, NULL),
(706, 'Observaciones de Proveedor', 'activo', NULL, 0, NULL),
...
(1, 1, 1, 1, 1, '2019-10-16 13:02:49', '2019-10-16 00:00:00', NULL, '', '0', 1),
(2, 1, 1, 1, 1, '2019-10-16 14:24:52', '2019-10-16 00:00:00', NULL, '', '3', 1);
...
INSERT INTO `tb_persona` (`id_persona`, `id_documento`, `num_documento`, `nombres`, `apellidos`, `direccion`, `telefono`, `correo`, `fecha_nacimiento`, `sexo`) VALUES
(1, 1, '77229532', 'Zhaúl Alberto', 'Valdera Vidaurre', 'Jr. Pedro Remy 177 - Urb. Ingeneria - SMP', '930744960', 'zvaldera@tecnovoperu.com', '1995-05-12', 'masculino'),
(2, 1, '12345678', 'Luisa Magnolia', 'Valdera Zurita', 'Jr. Pedro Remy N 317 - Urbanización Ingenería', '987654321', 'zhaul_aries15@hotmail.com', '2000-12-07', 'femenino'),
(3, 3, '20202020202', 'Pedigree SAC', 'Pedigree SAC', 'Jr. Pedro Remy N 317 - Urbanización Ingenería', '012083489', '', '2019-10-16', 'masculino'),
(4, 1, '09890978', 'David', 'Moreno', 'Jr. Pedro Remy N 317 - Urbanización Ingenería', '987654341', 'davidmoreno@gmail.com', '1989-10-16', 'masculino'),
(5, 1, '76589746', 'Irving', 'Tovar', 'Jr. Pedro Remy N 317 - Urbanización Ingenería', '987654321', 'irvingtovar@gmail.com', '1989-10-16', 'masculino');
...
(1, 3, '1', 'resources/global/images/persons/img-1571244091.png');
...
INSERT INTO `tb_servicio` (`id_servicio`, `id_tipo_servicio`, `name_servicio`, `descripcion_breve`, `descripcion_larga`, `id_moneda`, `signo_moneda`, `precio`, `flag_igv`, `src_imagen`, `estado`) VALUES
(1, 1, 'Medicina preventiva', 'Contamos con excelentes programas de medicina preventiva como es la aplicación de vacunas para perros, gatos y mucho más...', 'También contamos con el chequeo geriátrico el cual recomendamos para perros de talla miniatura a partir de los 9 años de edad, los perros de talla media a partir de los 7 años y los de talla gigante como el gran danés o san bernardo a partir de los 6 años.', 1, 'S/', '45.00', '1', 'resources/global/images/servicios/img-1571244152.png', 'activo'),
(2, 2, 'Consultas', 'La Clínica Veterinaria del Bosque cuenta con médicos veterinarios expertos en diferentes disciplinas y con la metodología necesaria para llegar a los ', 'Seguimos a detalle el expediente clínico orientado a problemas, en el que al conjuntar los datos generales, la historia clínica y el examen clínico.', 1, 'S/', '20.00', '1', 'resources/global/images/servicios/img-1571244190.png', 'activo'),
(3, 3, 'Cirugía', 'En la Clínica Veterinaria del Bosque contamos con quirófano equipado con anestesia inhalada y monitores trans quirúrgicos.', 'Frecuencia respiratoria, cantidad de oxigeno y bióxido de carbono circulante en el organismo de nuestra mascota, entre otras  mientras son intervenidas quirúrgicamente, nuestro quirófano cuenta también con la instrumentación suficiente para la práctica de cirugía en tejidos blandos.', 2, '$', '250.00', '1', 'resources/global/images/servicios/img-1571244228.png', 'activo'),
(4, 3, 'Hospitalización', 'Contamos con las instalaciones y el personal capacitado para brindar el internamiento de pacientes con fines tanto terapéuticos como diagnostico.', 'Cuenta con la flexibilidad para ofrecer  hospitalización diurna en donde los pacientes son internados durante el día para la supervisión y administración de fármacos o tratamientos mientras los propietarios trabajan.', 3, '€', '50.00', '1', 'resources/global/images/servicios/img-1571244267.png', 'activo'),
(5, 4, 'Medicina interna', 'Contamos con los métodos diagnósticos y tratamiento de las enfermedades de los órganos internos de manera no quirúrgica con este fin hemos incorporado', 'Imagenología, electrocardiografía, entre otros y también colaboran un excelente equipo de expertos en disciplinas como oftalmología (Dr. Fred Pineda),', 1, 'S/', '200.00', '1', 'resources/global/images/servicios/img-1571244302.png', 'activo'),
(6, 5, 'Imagenología', 'La Clínica Veterinaria del Bosque cuenta con métodos diagnósticos de alta calidad como son radiología de alta frecuencia que es un equipo de rayos X.', 'Se cuenta también con ecosonografía y endoscopía de fibra óptica, estas técnicas complementarias ayudan a tener métodos diagnósticos confiables para enfocar la terapia de manera eficiente.', 2, '$', '65.00', '1', 'resources/global/images/servicios/img-1571244338.png', 'activo'),
(7, 6, 'Laboratorio de análisis clínico', 'Laboratorios integrados que le permite correr pruebas como química sanguínea en húmeda y seca, lo que facilita la obtención de datos a cualquier hora.', 'Y en cuestión de minutos, hemograma (biometría hemética), coproparasitología, prueba que ayuda a la detección de parásitos o huevos de los mismos en heces fecales, serología, estas últimas.', 2, '$', '23.00', '1', 'resources/global/images/servicios/img-1571244377.png', 'activo');
...
(2, 4, 2, 4, 'davidmoreno@gmail.com', '1dd4ecb6f7f0091bc464fee9b9202d59', NULL, '2019-10-16', NULL, 'resources/global/images/persons/img-1571246568.png', 'activo', 1, 'https://www.facebook.com', 'https://www.instagram.com', 'https://www.twitter.com', 'Profesional muy destacado en el ambiente laboral, se caracteriza por su habilidad de comunicar al cliente.'),
(3, 5, 2, 3, 'irvingtovar@gmail.com', '1dd4ecb6f7f0091bc464fee9b9202d59', NULL, '2019-10-16', NULL, 'resources/global/images/persons/img-1571246677.png', 'activo', 1, 'https://www.facebook.com', 'https://www.instagram.com', 'https://www.twitter.com', 'Su área de competencia es medicina interna y cirugía de tejidos blandos, con especial dedicación a la reproducción canina y endocrinóloga.');
...
(1, 1, 1, 1, 'BOLETA', '2', 'BPP1', '1', 1, 'DNI', '1', '12345678', 1, '01', 'EFECTIVO', 'Luisa Magnolia Valdera Zurita', 'Jr. Pedro Remy N 317 - Urbanización Ingenería', '987654321', 'zhaul_aries15@hotmail.com', '2019-10-16 00:00:00', NULL, '0.00', '1426.91', '256.84', '1683.75', '2', 'https://www.pse.pe/cpe/b8bd5e9b-1ba7-4618-9a82-70c0ca8df487-e28e10e8-a836-469c-8540-ed8f0c8bf2b1.pdf', 'https://www.pse.pe/cpe/b8bd5e9b-1ba7-4618-9a82-70c0ca8df487-e28e10e8-a836-469c-8540-ed8f0c8bf2b1.xml', 'https://www.pse.pe/cpe/b8bd5e9b-1ba7-4618-9a82-70c0ca8df487-e28e10e8-a836-469c-8540-ed8f0c8bf2b1.cdr', NULL, 'https://www.pse.pe/api/v1/74142b6b76614a74a26d9b8e347d4ff8f3962e1276a9403fae3652c010416ba4', 'eyJhbGciOiJIUzI1NiJ9.IjE2NDBjYTc5ODM1MzRkZTdhOWJjNGM3YzAxNmQ5NzRjYzY2MDJiY2RiMjE0NGNjYWEzMGFmODE3MjA1NWJkOGYi.IcO44mj7fdDqzDMhCymLuw0l0PrKfnhAcUwERs_Smjc', '0', '1683.75', '0.00', 1, '1', 'S/', 'PEN', 'S/ ', '1.00', NULL, '1');
...
ALTER TABLE `tb_cita`
  ...
  ADD KEY `tb_cita_id_mascota_foreign` (`id_mascota`),
  ADD KEY `id_sucursal` (`id_sucursal`);
...
--
ALTER TABLE `tb_accesorio`
  MODIFY `id_accesorio` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tb_documento_venta`
  MODIFY `id_documento_venta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tb_trabajador`
  MODIFY `id_trabajador` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
ALTER TABLE `tb_cita`
  ...
  ADD CONSTRAINT `tb_cita_id_mascota_foreign` FOREIGN KEY (`id_mascota`) REFERENCES `tb_mascota` (`id_mascota`),
