...
(1, 2, 'zaid', 'd41d8cd98f00b204e9800998ecf8427e', NULL, '2019-10-16', NULL, 'resources/global/images/persons/img-1571243739.png', 'activo'),
(2, 10, '', '', NULL, '2024-09-30', NULL, 'resources/global/images/sin_imagen.png', 'activo');
...
INSERT INTO `tb_documento_venta` (`id_documento_venta`, `id_fundo`, `cod_sunat`, `nombre`, `nombre_corto`, `serie`, `correlativo`, `estado`, `flag_doc_interno`) VALUES
...
(1, 3, '10707623433', 'SYSCOS', 'SysCos: Sistema para la gestión de cosechas', 'Jr. Pedro Remy N 239, San Martín de Porres - Lima - Lima', '916028408', 'informes@syscoss.com', 'https://syscos-sistemas.com/', 1, '70762343', 'Hector', 'Laboe', '916028408', 'jolu@syscos.com', 'activo', 'resources/global/images/business_logo/img-1571242080.jpg');
...
(1, 1, 'MALVINAS', '150302', 'JR. TOMÁS GUIDO N 239 - OF. 302 - LINCE', '987654326', '', '1', '', ''),
(2, 1, 'SOL NACIENTE', '1086767', '', '928373817', '', '1', '', ''),
(3, 1, '16 DE NOVIEMBRE', '19029838', '', '', '', '1', '', ''),
(4, 1, 'FLOR DEL VALLE', '109283', '', '', '', '1', '', ''),
(5, 1, 'LIBERTAD', '102823', '', '', '', '1', '', ''),
(6, 1, 'SAN JUAN', '102832', '', '', '', '1', '', ''),
(7, 1, 'MARONAL', '120384', '', '', '', '1', '', ''),
(8, 1, 'CURIMANA', '20283', '', '', '', '1', '', ''),
(9, 1, 'OTROS', '892893', '', '', '', '1', '', '');
...
INSERT INTO `tb_gasto` (`id_gasto`, `id_tipo_gasto`, `name_gasto`, `descripcion_gasto`, `flag_igv`, `estado`) VALUES
(1, 3, 'BALDE DE ACEITES', 'Balde de Aceite de 140 caja', '0', 'activo'),
(2, 3, 'FILTRO DE HST', 'Partes de reemplazo en la maquinaria', '0', ''),
(3, 3, 'MANGUERA DE BOMBA', 'Manguera de bomba de dirección', '1', 'activo'),
(5, 4, 'MANTENIMIENTO', 'Mantenimiento preventivo de camioneta', '1', 'activo'),
(6, 4, 'REPARACIÓN DE CAÑERIAS', 'Reparación de cañerias de combustible', '0', '');
...
INSERT INTO `tb_maquinaria` (`id_maquinaria`, `descripcion`, `observaciones`, `estado`) VALUES
(1, 'MAQUINA 1', 'Defectuosa', ''),
(2, 'MAQUINA 3', 'Cambiar manguera de agua', 'activo');
...
(115, 'Tipos de Cosecha', 'activo', NULL, 15, NULL),
...
(606, 'Ordenes de Gastos', 'activo', NULL, 0, NULL),
...
(1, 7, '', '', NULL, '2024-09-27', NULL, 'resources/global/images/sin_imagen.png', 'activo'),
(2, 9, '', '', NULL, '2024-09-27', NULL, 'resources/global/images/sin_imagen.png', 'activo');
...
INSERT INTO `tb_orden_compra` (`id_orden_compra`, `id_metodo_envio`, `id_proveedor`, `id_trabajador`, `id_fundo`, `fecha_orden`, `fecha_entrega`, `descripcion`, `observaciones`, `estado`, `id_moneda`) VALUES
...
INSERT INTO `tb_persona` (`id_persona`, `id_documento`, `num_documento`, `nombres`, `apellidos`, `nickname`, `direccion`, `telefono`, `correo`, `fecha_nacimiento`, `sexo`) VALUES
(1, 1, '77229532', 'Zhaúl Alberto', 'Valdera Vidaurre', NULL, 'JR. PEDRO REMY 177 - URB. INGENERIA - SMP', '930744960', 'ZVALDERA@TECNOVOPER.COM', '1995-05-12', 'masculino'),
(2, 1, '12345678', 'Luisa Magnolia', 'Valdera Zurita', NULL, 'Jr. Pedro Remy N 317 - Urbanización Ingenería', '987653243', 'zhaul_aries15@hotmail.com', '2000-12-07', 'femenino'),
(4, 1, '09890978', 'David', 'Moreno', NULL, 'Jr. Pedro Remy N 317 - Urbanización Ingenería', '987654341', 'davidmoreno@gmail.com', '1989-10-16', 'masculino'),
(5, 1, '76589746', 'Irving', 'Tovar', NULL, 'Jr. Pedro Remy N 317 - Urbanización Ingenería', '987654321', 'irvingtvar@gmail.com', '1989-10-16', 'masculino'),
(7, 1, '45343212', 'RAUL THOMAS', 'AGHATA MANRIQUE', NULL, 'AV LOS OLIVOS EN EL PARADERO 50', '927828321', 'RAUL@GMAIL.COM', '2003-04-18', 'masculino'),
(9, 3, '209183838387', 'SAC', 'THE DIALEX S', NULL, 'AVENIDA COLOMBIA 203', '564657656', 'DIALEX@GMAIL.COM', '2001-04-24', 'masculino'),
(10, 1, '38274382', 'Eduardo Daniel', 'Peralta Cuya', 'carlos', 'avv los jardines', '978662654', 'danic@gmail.com', '2000-07-19', 'masculino'),
(11, 1, '70570131', 'danico', 'peraleduard', NULL, 'dewwffeferge', '243454344', 'dafegfasda@gmail.com', '2024-10-07', 'masculino');
...
(1, 11, '1', 'resources/global/images/sin_imagen.png');
...
(1, 1, 'Protección de hectáreas', 'Cuidado de las áreas de cosecha frente a amenazas', 'También se verificará el estado de las plantaciones u observaciones rutinarios', 1, 'S/', 40.00, '1', 'resources/global/images/servicios/img-1727187464.png', 'activo'),
(2, 2, 'Distribución del agua', 'Monitorear los sistemas de riego ', 'Observación para posibles reparos en los sistemas de cañerias ubicados dentro de la hectarea', 1, 'S/', 60.00, '1', 'resources/global/images/servicios/img-1727187708.png', 'activo'),
(3, 7, 'Reparación rutinaria', 'Observación y mantenimiento de maquinarias', '', 2, '$', 60.00, '1', 'resources/global/images/servicios/img-1571244228.png', 'activo');
...
INSERT INTO `tb_tipo_gasto` (`id_tipo_gasto`, `descripcion`, `estado`) VALUES
...
INSERT INTO `tb_trabajador` (`id_trabajador`, `id_persona`, `id_grupo`, `name_user`, `pass_user`, `cod_recuperacion`, `fecha_activacion`, `fecha_recuperacion`, `src_imagen`, `estado`, `flag_medico`, `link_facebook`, `link_instagram`, `link_twitter`, `descripcion`) VALUES
(1, 1, 1, 'zhaul', 'e67f455a5414e8f58488ae39fe9e7f76', NULL, '2019-06-10', NULL, 'resources/global/images/persons/zhaul-1571241993.png', 'activo', 0, '#', '#', '#', ''),
(2, 4, 1, 'davidmoreno@gmail.com', '1dd4ecb6f7f0091bc464fee9b9202d59', NULL, '2019-10-16', NULL, 'resources/global/images/persons/img-1727713943.png', 'activo', 0, '', '', '', 'Profesional muy destacado en el ambiente laboral, se caracteriza por su habilidad de comunicar al cliente.'),
(3, 5, 1, 'irvingtovar@gmail.com', '1dd4ecb6f7f0091bc464fee9b9202d59', NULL, '2019-10-16', NULL, 'resources/global/images/persons/img-1571246677.png', 'activo', 0, '', '', '', 'Su área de competencia es medicina interna y cirugía de tejidos blandos, con especial dedicación a la reproducción canina y endocrinóloga.');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_orden_gasto`  AS SELECT `og`.`id_orden_gasto` AS `id_orden_gasto`, `p`.`id_proveedor` AS `id_proveedor`, `p`.`nombre_proveedor` AS `nombre_proveedor`, `p`.`src_imagen_proveedor` AS `src_imagen_proveedor`, `og`.`fecha_gasto` AS `fecha_gasto`, `og`.`observaciones` AS `observaciones`, `m`.`id_moneda` AS `id_moneda`, `g`.`id_gasto` AS `id_gasto`, `g`.`name_gasto` AS `name_gasto`, `og`.`precio_unit` AS `precio`, `og`.`cantidad_ga` AS `cantidad_solicitada`, (`og`.`precio_unit` * `og`.`cantidad_ga`) AS `total` FROM (((`tb_orden_gasto` `og` join `vw_proveedores` `p` on((`og`.`id_proveedor` = `p`.`id_proveedor`))) join `tb_moneda` `m` on((`og`.`id_moneda` = `m`.`id_moneda`))) join `tb_gasto` `g` on((`og`.`id_gasto` = `g`.`id_gasto`))) ;
...
--
ALTER TABLE `tb_accesorio`
  MODIFY `id_accesorio` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tb_categoria_accesorio`
  MODIFY `id_categoria` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_detalle_compra`
  MODIFY `id_detalle` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `tb_documento_identidad`
  MODIFY `id_documento` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `tb_documento_venta`
--
ALTER TABLE `tb_documento_venta`
  MODIFY `id_documento_venta` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tb_fundo`
  MODIFY `id_fundo` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `tb_gasto`
  MODIFY `id_gasto` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `tb_grupo_usuario`
--
ALTER TABLE `tb_grupo_usuario`
  MODIFY `id_grupo` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `tb_ingreso_gasto`
--
ALTER TABLE `tb_ingreso_gasto`
  MODIFY `id_ingreso_gasto` bigint NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tb_maquinaria`
--
ALTER TABLE `tb_maquinaria`
  MODIFY `id_maquinaria` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tb_operador`
  MODIFY `id_operador` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `tb_orden_gasto`
--
ALTER TABLE `tb_orden_gasto`
  MODIFY `id_orden_gasto` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tb_persona`
--
ALTER TABLE `tb_persona`
  MODIFY `id_persona` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tb_servicio`
  MODIFY `id_servicio` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tb_tipo_cosecha`
  MODIFY `id_tipo_cosecha` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `tb_tipo_gasto`
--
ALTER TABLE `tb_tipo_gasto`
  MODIFY `id_tipo_gasto` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `tb_tipo_servicio`
--
ALTER TABLE `tb_tipo_servicio`
  MODIFY `id_tipo_servicio` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `tb_trabajador`
--
ALTER TABLE `tb_trabajador`
  MODIFY `id_trabajador` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
ALTER TABLE `tb_accesorio`
  ...
  ADD CONSTRAINT `tb_accesorio_ibfk_4` FOREIGN KEY (`id_fundo`) REFERENCES `tb_fundo` (`id_fundo`),
...
--
ALTER TABLE `tb_cliente_fundo`
  ADD CONSTRAINT `tb_cliente_fundo_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `tb_cliente` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tb_cliente_fundo_ibfk_2` FOREIGN KEY (`id_fundo`) REFERENCES `tb_fundo` (`id_fundo`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tb_compra`
--
ALTER TABLE `tb_compra`
  ADD CONSTRAINT `tb_compra_ibfk_1` FOREIGN KEY (`id_fundo`) REFERENCES `tb_fundo` (`id_fundo`),
...
--
ALTER TABLE `tb_documento_venta`
  ADD CONSTRAINT `tb_documento_venta_ibfk_1` FOREIGN KEY (`id_fundo`) REFERENCES `tb_fundo` (`id_fundo`);
...
--
ALTER TABLE `tb_fundo`
  ADD CONSTRAINT `tb_fundo_ibfk_1` FOREIGN KEY (`id_empresa`) REFERENCES `tb_empresa` (`id_empresa`);

--
-- Filtros para la tabla `tb_gasto`
--
ALTER TABLE `tb_gasto`
  ADD CONSTRAINT `tb_gasto_ibfk_1` FOREIGN KEY (`id_tipo_gasto`) REFERENCES `tb_tipo_gasto` (`id_tipo_gasto`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tb_operador`
--
ALTER TABLE `tb_operador`
  ADD CONSTRAINT `tb_operador_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `tb_persona` (`id_persona`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `tb_orden_gasto`
--
ALTER TABLE `tb_orden_gasto`
  ADD CONSTRAINT `tb_orden_gasto_ibfk_1` FOREIGN KEY (`id_proveedor`) REFERENCES `tb_proveedor` (`id_proveedor`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tb_proveedor`
  ADD CONSTRAINT `tb_proveedor_ibfk_1` FOREIGN KEY (`id_persona`) REFERENCES `tb_persona` (`id_persona`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tb_venta`
  ADD CONSTRAINT `tb_venta_ibfk_1` FOREIGN KEY (`id_fundo`) REFERENCES `tb_fundo` (`id_fundo`),
