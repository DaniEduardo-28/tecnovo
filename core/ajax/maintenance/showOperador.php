<?php
  ...
  if (!empty($fecha_nacimiento)) {
    ...
    $fecha_nacimiento = null; // O establece un valor predeterminado si es necesario
}
...
/*     if (empty(trim($name_user))) {
    ...
    switch ($accion) {
      case 'add':
        $VD = $OBJ_OPERADOR->insert($id_persona,$id_operador,$id_documento,$num_documento,$nombres,$apellidos,$direccion,$correo,$telefono,$fecha_nacimiento,$sexo,$estado,$flag_imagen,$src_imagen,$name_user,$pass_user);
        break;
      case 'edit':
        $VD = $OBJ_OPERADOR->update($id_persona,$id_operador,$id_documento,$num_documento,$nombres,$apellidos,$direccion,$correo,$telefono,$fecha_nacimiento,$sexo,$estado,$flag_imagen,$src_imagen,$name_user,$pass_user);
        break;
      default:
