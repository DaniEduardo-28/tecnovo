<?php
  ...
  try {
    ...
    switch ($accion) {
      case 'add':
        $VD = $OBJ_MEDICAMENTO->insert($id_medicamento,$id_tipo_medicamento,$name_medicamento,$descripcion,$stock,$stock_minimo,$precio_compra,$precio_venta,$estado,$flag_imagen,$src_imagen,$id_fundo,$id_unidad_medida,$id_moneda,$flag_igv);
        break;
      case 'edit':
        $VD = $OBJ_MEDICAMENTO->update($id_medicamento,$id_tipo_medicamento,$name_medicamento,$descripcion,$stock,$stock_minimo,$precio_compra,$precio_venta,$estado,$flag_imagen,$src_imagen,$id_fundo,$id_unidad_medida,$id_moneda,$flag_igv);
        break;
      default:
