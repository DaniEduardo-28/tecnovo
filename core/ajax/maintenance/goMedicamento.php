<?php
  ...
  $name_medicamento = isset($_POST["name_medicamento"]) ? $_POST["name_medicamento"] : "";
  ...
  try {
    ...
    if (empty(trim($id_sucursal))) {
      throw new Exception("Campo obligatorio : Id Sucursal.");
    }
    ...
    if ($flag_imagen=="1") {
      ...
      if (isset($_FILES["src_imagen"])){
        ...
        $carpeta = "resources/global/images/medicamentos/";
    ...
    switch ($accion) {
      case 'add':
        $VD = $OBJ_MEDICAMENTO->insert($id_medicamento,$id_tipo_medicamento,$name_medicamento,$descripcion,$stock,$stock_minimo,$precio_compra,$precio_venta,$estado,$flag_imagen,$src_imagen,$id_sucursal,$id_unidad_medida,$id_moneda,$flag_igv);
        break;
      case 'edit':
        $VD = $OBJ_MEDICAMENTO->update($id_medicamento,$id_tipo_medicamento,$name_medicamento,$descripcion,$stock,$stock_minimo,$precio_compra,$precio_venta,$estado,$flag_imagen,$src_imagen,$id_sucursal,$id_unidad_medida,$id_moneda,$flag_igv);
        break;
      default:
