<?php
  ...
  try {
    ...
    $id_sucursal = isset($_POST["id_sucursal"])	? $_POST["id_sucursal"]	: $_SESSION['id_sucursal'];
    ...
    $DataCantidad = $OBJ_ORDEN_COMPRA->getCountDetalleParaOrden($id_sucursal,$tipo,$valor);

    if ($DataCantidad["error"]=="NO") {

      $cantidad = $DataCantidad["data"][0]["cantidad"];
      $Resultado = $OBJ_ORDEN_COMPRA->showDetalleParaOrden($id_sucursal,$tipo,$valor,$offset,$limit);
