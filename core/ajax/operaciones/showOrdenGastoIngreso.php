<?php
  ...
  try {
    ...
    $DataCantidad = $OBJ_ORDEN_GASTO->getCount1($valor,$fecha_inicio,$fecha_fin,$tipo_busqueda);

    if ($DataCantidad["error"]=="NO") {

      $cantidad = $DataCantidad["data"][0]["cantidad"];
      $Resultado = $OBJ_ORDEN_GASTO->show1($valor,$fecha_inicio,$fecha_fin,$tipo_busqueda,$offset,$limit);
      $count = 1;
