...
class ClassTrabajador extends Conexion
{
	...
	public function insert($id_persona, $id_trabajador, $id_grupo, $id_especialidad, $id_documento, $num_documento, $nombres, $apellidos, $direccion, $correo, $telefono, $fecha_nacimiento, $sexo, $estado, $flag_imagen, $src_imagen, $name_user, $pass_user, $flag_medico, $descripcion, $link_facebook, $link_instagram, $link_twitter, $apodo)
	{
		$conexionClass = new Conexion();
		$conexion = $conexionClass->Open();
		$VD = "";
	...
	public function update($id_persona, $id_trabajador, $id_grupo, $id_especialidad, $id_documento, $num_documento, $nombres, $apellidos, $direccion, $correo, $telefono, $fecha_nacimiento, $sexo, $estado, $flag_imagen, $src_imagen, $name_user, $pass_user, $flag_medico, $descripcion, $link_facebook, $link_instagram, $link_twitter, $apodo)
	{
		$conexionClass = new Conexion();
		$conexion = $conexionClass->Open();
		$VD = "";
