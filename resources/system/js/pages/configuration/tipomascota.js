...
$(document).ready(function(){
  ...
  $('#example tbody').on( 'click', '#btnDelete', function () {
    try {
      ...
      var data = table.row( $(this).parents('tr') ).data();
      var id_tipo_mascota = data["id_tipo_mascota"];
      ...
      Swal.fire({
        title: '¿Seguro de eliminar el tipo de mascota : ' + name_tipo + '?',
        ...
        if (result.value) {
          $.ajax({
            type: "POST",
            url: "ajax.php?accion=deleteTipoMascota",
            datatype: "json",
            data: parametros,
...
function showData(){
  $.ajax({
    url: "ajax.php?accion=showTipoMascota",
    success : function(data) {
      table.clear().draw();
      try {
...
function saveOperation(){
  ...
  Swal.fire({
    ...
    if (result.value) {
      $.ajax({
        type: "POST",
        url: "ajax.php?accion=goTipoMascota",
        datatype: "json",
