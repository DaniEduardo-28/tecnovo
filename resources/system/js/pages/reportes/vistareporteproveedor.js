...
$('#btnBuscarOrden').on('click', function () {
  ...
  $('#btnReporteExcel').click(function () {
    try {
        ...
        const link = `?view=reporteproveedorexcel&fecha_inicio=${fecha_inicio}&fecha_fin=${fecha_fin}&filterUser=${filterUser}&filterTable=${filterTable}`;
  ...
  $('#btnReportePdf').click(function () {
    try {
        ...
        // Generar link con parámetros
        const link = `?view=reporteproveedorpdf&fecha_inicio=${fecha_inicio}&fecha_fin=${fecha_fin}&filterUser=${filterUser}&filterTable=${filterTable}`;
        window.open(link, '_blank');
    } catch (e) {
