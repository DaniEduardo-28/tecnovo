var table = $("#example").DataTable({
  ...
  paging: false,
  ordering: false,
  columns: [{ data: "num" }, { data: "options" }, { data: "id_venta" }, { data: "estado" }, { data: "doc_venta" }, { data: "doc_identidad" }, { data: "cliente" }, { data: "direccion" }, { data: "fecha" }, { data: "moneda" }, { data: "metodo_pago" }, { data: "sub_total" }, { data: "igv" }, { data: "total" }, { data: "tipo_cambio" }],
  columnDefs: [
    {
...
$(document).ready(function () {
  ...
  $("#btnReportePdf").click(function () {
    ...
    try {
      ...
      var link = "?view=reporteventaspdf&id_doc_venta=" + id_doc_venta + "&id_doc_cliente=" + id_doc_cliente + "&fecha_inicio=" + fecha_inicio + "&fecha_fin=" + fecha_fin + "&valor=" + valor;
      window.open(link);
    } catch (e) {
      console.log(e);
    }
  ...
  $("#btnReporteExcel").click(function () {
    ...
    try {
      ...
      var fecha_fin = $("#txtFechaFin").val();
      var valor = $("#txtBuscar").val();
      var link = "?view=reporteventasexcel&id_doc_venta=" + id_doc_venta + "&id_doc_cliente=" + id_doc_cliente + "&fecha_inicio=" + fecha_inicio + "&fecha_fin=" + fecha_fin + "&valor=" + valor;
      window.open(link);
    } catch (e) {
      console.log(e);
    }
