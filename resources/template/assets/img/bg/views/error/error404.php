                                      ...
                                      <div class="row justify-content-center align-items-center">
                                        <div class="col-md-8 text-center">
                                          <div class="error-text">
                                            ...
                                            <h3 class="m-t-30">La Página que estas buscando no se encutra disponible</h3>
                                            <p>Posiblemente la página fue removida del servidor. Si cree que es un error comunicarse con el área de sistemas.</p>
                                          </div>
                                        </div>
                                      </div>
                                    </div>
