...
<html>
  ...
  <head>
    ...
    <title>Socios - Página Web | <?=APP_TITLE;?> </title>
    <style media="screen">
      .pagination {
  ...
  <body>
                              ...
                              <div class="card card-statistics">
                                <div class="card-header">
                                    <div class="card-heading">
                                        <h4 class="card-title">Socios - Página Web</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <form id="frmDatos" name="frmDatos" enctype="multipart/form-data">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="form-group col-sm-4">
                                              ...
                                              alt="Logo de socio" class="img-fluid"
                                              style="width:127px;height:127px;">
                                              <br>
                                              <label for="">Logo de socio</label>
                                              <br>
                                            ...
                                            <div class="form-group col-sm-6">
                                              ...
                                              <div class="form-group col-xs-12">
                                                <label for="titulo" class="label-control">Nombres</label>
                                                <input id="titulo" type="text" name="titulo" class="form-control"
                                                autocomplete="off" required data-msg="Campo obligatorio...">
                                              </div>

                                              <div class="form-group col-xs-12">
                                                <label for="descripcion" class="label-control">Url Página Web</label>
    ...
    <script src="resources/system/js/pages/paginaweb/websocio.js?v=<?=APP_VERSION;?>"></script>
    <script>
      $("#menupaginaweb").addClass('active');
      $("#menuwebsocio").addClass('active');
    </script>
