...
<html>
  ...
  <head>
    ...
    <title>Testimonios - Página Web | <?=APP_TITLE;?> </title>
    <style media="screen">
      .pagination {
  ...
  <body>
                              ...
                              <div class="card card-statistics">
                                <div class="card-header">
                                    <div class="card-heading">
                                        <h4 class="card-title">Testimonios - Página Web</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <form id="frmDatos" name="frmDatos" enctype="multipart/form-data">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="form-group col-sm-4">
                                              ...
                                              alt="Imagen del cliente" class="img-fluid"
                                            ...
                                            <div class="form-group col-sm-6">
                                              ...
                                              <div class="form-group col-xs-12">
                                                <label for="titulo" class="label-control">Cliente</label>
                                                <input id="titulo" type="text" name="titulo" class="form-control"
                                                autocomplete="off" required data-msg="Campo obligatorio...">
                                              </div>

                                              <div class="form-group col-xs-12">
                                                <label for="descripcion" class="label-control">Opinión</label>
                                                <textarea id="descripcion" name="descripcion" rows="8" cols="80" class="form-control"></textarea>
                                              </div>
    ...
    <script src="resources/system/js/pages/paginaweb/webtestimonio.js?v=<?=APP_VERSION;?>"></script>
    <script>
      $("#menupaginaweb").addClass('active');
      $("#menuwebtestimonio").addClass('active');
    </script>
