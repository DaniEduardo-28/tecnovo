...
<html>
  ...
  <head>
    ...
    <title>Unidades de Medida | <?=APP_TITLE;?> </title>
  ...
  <body>
                                    ...
                                    <div class="col-md-12" id="panelForm"> <!-- d-none -->
                                      <div class="ser-block block">
                                        <form action="#" method="post" id="frmDatos" name="frmDatos">
                                          ...
                                          <input type="hidden" name="id_unidad_medida" id="id_unidad_medida" value="">
                                          <input type="hidden" name="accion" id="accion" value="add">

                                          <div class="row">
                                            <div class="form-group col-md-4 col-sm-6">
                                              <label for="name_unidad" class="label-control">Unidad de Medida</label>
                                              <input id="name_unidad" type="text" name="name_unidad" class="form-control"
                                          ...
                                          <table id="example" class="table table-bordered">
                                            <thead>
                                              <tr>
                                                ...
                                                <th style="width:50px; text-align: center;">Código Sunat</th>
    ...
    <script src="resources/system/js/pages/configuration/unidadmedida.js?v=<?=APP_VERSION;?>"></script>
    <script>
      $("#menuconfiguration").addClass('active');
      $("#menuunidadmedida").addClass('active');
    </script>
