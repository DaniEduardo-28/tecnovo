...
<html>
  ...
  <head>
    ...
    <title>Operador - Servicio | <?=APP_TITLE;?> </title>
    <style media="screen">
                                        ...
                                        <?php
                                            ...
                                            if ($access_options[0]['error']=="NO") {
                                              if ($access_options[0]['flag_editar']) {
                                                ...
                                                $dataMedicos = $OBJ_TRABAJADOR->getMedicos("all");
                                                if ($dataMedicos['error']=="NO") {
                                                  foreach ($dataMedicos['data'] as $key) {
                                                    ?>
                                                      <option value="<?=$key['id_trabajador'];?>"><?=$key['nombres_medico'];?></option>
                                                    <?php
                                                  }
                                                }
                                              }
                                      ...
                                      <div class="user-block block">
                                        <div class="table-responsive">
                                          <table id="example" class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                  require("core/models/ClassServicio.php");
                                                  $dataServicios = $OBJ_SERVICIO->show_all();
                                                  if ($dataServicios['error']=="NO") {
                                                    $num = 1;
                                                    foreach ($dataServicios['data'] as $key) {
                                                      ?>
                                                        <tr>
                                                          <td><?=$num;?></td>
                                                          <td><?=$key['id_servicio'];?></td>
                                                          <td><?=$key['name_tipo'];?></td>
                                                          <td><?=$key['name_servicio'];?></td>
