...
<html>
  ...
  <body>
                                    ...
                                    <div class="col-md-12" id="panelForm"> <!-- d-none -->
                                      <div class="ser-block block">
                                        <form id="frmDatos" name="frmDatos" enctype="multipart/form-data">
                                          ...
                                          <input type="hidden" name="id_medicamento" id="id_medicamento" value="0">
                                            ...
                                            <div class="form-group col-sm-6">
                                              ...
                                              <div class="form-group col-xs-12">
                                                ...
                                                <select name="id_tipo_medicamento" id="id_tipo_medicamento" class="form-control" required>
                                                  ...
                                                  <?php
                                                    include("core/models/ClassTipoMedicamento.php");
                                                    $dataTipoMedicamento = $OBJ_TIPO_MEDICAMENTO->show("activo");
                                                    if ($dataTipoMedicamento["error"]=="NO") {
                                                      foreach ($dataTipoMedicamento["data"] as $key) {
                                                        echo '<option value="' . $key['id_tipo_medicamento'] . '">' . $key['name_tipo'] . '</option>';
                                                      }
                                                    }
                                                   ?>
                                                </select>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                              ...
                                              <input id="stock" type="number" name="stock" value="0"
                                            ...
                                            <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                              ...
                                              <input id="stock_minimo" type="number" name="stock_minimo"
                                            ...
                                            <div class="form-group col-md-3 col-sm-4">
                                              <label for="precio_compra" class="label-control">Precio Compra</label>
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                          <div class="form-group">
                                            ...
                                            <select class="form-control" name="cboTipoBuscar" id="cboTipoBuscar">
                                              ...
                                              <?php
                                                $dataTipoMedicamento = $OBJ_TIPO_MEDICAMENTO->show("all");
                                                if ($dataTipoMedicamento["error"]=="NO") {
                                                  foreach ($dataTipoMedicamento["data"] as $key) {
                                                    echo '<option value="' . $key['id_tipo_medicamento'] . '">' . $key['name_tipo'] . '</option>';
                                                  }
                                        ...
                                        <div class="row justify-content-center align-items-center">
                                          <div class="col-md-8 text-center">
                                            <div class="error-text">
                                              ...
                                              <p>Posiblemente no tiene ningún medicamento registrado con los parametros de busqueda</p>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
    ...
    <script src="resources/system/js/pages/mantenimiento/medicamento.js?v=<?=APP_VERSION;?>"></script>
    <script>
      $("#menumantenimiento").addClass('active');
      $("#menumedicamento").addClass('active');
    </script>
