...
<html>
  ...
  <head>
    ...
    <title>Métodos de Envío | <?=APP_TITLE;?> </title>
  ...
  <body>
                              ...
                              <div class="card card-statistics">
                                <div class="card-header">
                                    <div class="card-heading">
                                        <h4 class="card-title">Métodos de Envío</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12" id="panelForm"> <!-- d-none -->
                                      <div class="ser-block block">
                                        <form action="#" method="post" id="frmDatos" name="frmDatos">
                                          ...
                                          <input type="hidden" name="id_metodo_envio" id="id_metodo_envio" value="">
                                          <input type="hidden" name="accion" id="accion" value="add">

                                          <div class="row">
                                            <div class="form-group col-md-4 col-sm-6">
                                              <label for="name_metodo" class="label-control">Método de Envío</label>
                                              <input id="name_metodo" type="text" name="name_metodo" class="form-control"
    ...
    <script src="resources/system/js/pages/configuration/metodoenvio.js?v=<?=APP_VERSION;?>"></script>
    <script>
      $("#menuconfiguration").addClass('active');
      $("#menumetodoenvio").addClass('active');
    </script>
