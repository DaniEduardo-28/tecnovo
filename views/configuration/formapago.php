...
<html>
  ...
  <head>
    ...
    <title>Métodos de Pago | <?=APP_TITLE;?> </title>
  ...
  <body>
                                        ...
                                        <form action="#" method="post" id="frmDatos" name="frmDatos">
                                          ...
                                          <div class="row">
                                            <div class="form-group col-md-4 col-sm-6">
                                              <label for="name_forma_pago" class="label-control">Método de Pago</label>
                                              <input id="name_forma_pago" type="text" name="name_forma_pago" class="form-control"
    ...
    <script src="resources/system/js/pages/configuration/formapago.js?v=<?=APP_VERSION;?>"></script>
    <script>
