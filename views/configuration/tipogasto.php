...
<body>
                ...
                <div class="card card-statistics">
                  <div class="card-header">
                    <div class="card-heading">
                      <h4 class="card-title">Tipo de Gastos</h4>
                    </div>
                  </div>
                  <div class="card-body">
                      ...
                      <div class="col-md-12 d-none" id="panelForm">
                        <div class="ser-block block">
                          <form action="#" method="post" id="frmDatos" name="frmDatos">
                            <input type="hidden" name="id_tipo_gasto" id="id_tipo_gasto" value="">
                            <input type="hidden" name="accion" id="accion" value="add">

                            <div class="row">
                              <div class="form-group col-md-12 col-sm-12">
                                <label for="desc_gasto" class="label-control">Descripción</label>
                                <input id="desc_gasto" type="text" name="desc_gasto" class="form-control"
                                  autocomplete="off">
                              </div>
  ...
  <script src="resources/system/js/pages/configuration/tipogasto.js?v=<?= APP_VERSION; ?>"></script>
  <script>
