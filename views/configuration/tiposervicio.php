...
<html>
  ...
  <head>
    ...
    <title>Unidad de Negocio | <?=APP_TITLE;?> </title>
  ...
  <body>
                                    ...
                                    <div class="col-md-12" id="panelForm"> <!-- d-none -->
                                      <div class="ser-block block">
                                        <form action="#" method="post" id="frmDatos" name="frmDatos">
                                          ...
                                          <input type="hidden" name="id_tipo_servicio" id="id_tipo_servicio" value="">
                                          <input type="hidden" name="accion" id="accion" value="add">

                                          <div class="row">
                                            <div class="form-group col-md-4 col-sm-6">
                                              <label for="name_tipo" class="label-control">Unidad de Negocio</label>
    ...
    <script src="resources/system/js/pages/configuration/tiposervicio.js?v=<?=APP_VERSION;?>"></script>
    <script>
      $("#menuconfiguration").addClass('active');
      $("#menutiposervicio").addClass('active');
    </script>
