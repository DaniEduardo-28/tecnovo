                                  ...
                                  <select name="id_documento" id="id_documento" class="form-control" required>
                                    ...
                                    if ($dataDocumento["error"] == "NO") {
                                      foreach ($dataDocumento["data"] as $key) {
                                        if (strtolower($key['name_documento']) !== 'ruc') { // Verifica si el nombre no es 'ruc'
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-md-2 col-sm-4">
                                ...
                                <div class="form-check">
                                  ...
                                  <label for="flag_medico" class="form-check-label">¿Es Operador?</label>
                                </div>
                              </div>
                              ...
                              <div class="form-group col-xs-12 d-none">
