  ...
  try {
    ...
    $objPHPExcel = new PHPExcel();
  	$objPHPExcel->getProperties()
          ...
          ->setTitle("Reporte de Medicamentos")
          ->setSubject("Reporte de Medicamentos")
          ->setDescription("Documento generado con PHPExcel")
          ->setKeywords("excel phpexcel php")
          ->setCategory("Reporte de Medicamentos");
    ...
    header('Content-Disposition: attachment;filename="' . $empresa[0]['razon_social'] . " - " . $_SESSION['nombre_sucursal'] . " - " . ' Reporte de Medicamentos' .  '.xlsx"');
