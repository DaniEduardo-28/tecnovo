<?php
  ...
  try {    
    ...
    $Resultado = $OBJ_GASTO_SERVICIO->showReportePendientes($valor,$fecha_inicio,$fecha_fin,"");
    ...
    $pdf->SetFont('Arial','',13);
  	...
  	$pdf->Cell(280,1,'CUENTAS POR PAGAR',0,0,'C',0);

  	$pdf->Ln(10);
    $pdf->SetX(5);
  	$pdf->SetFont('Arial','B',8);
  	$pdf->Cell(10,5,'#',1,0,'C',0);
  	$pdf->Cell(35,5,'TIPO DE REGISTRO',1,0,'C',0);
    $pdf->Cell(40,5,'FECHA EMITIDA',1,0,'C',0);
  	$pdf->Cell(100,5,'NOMBRE DEL PROVEEDOR',1,0,'L',0);
    ...
    $pdf->Cell(30,5,'MONTO PENDIENTE',1,0,'L',0);
      ...
      $pdf->SetX(5);
  		...
  		$pdf->Cell(35,5,utf8_decode($key['tipo_registro']),1,0,'C',0);
      $pdf->Cell(40,5,$key['fecha'],1,0,'C',0);
      $pdf->Cell(100,5,$key['nombre_proveedor'],1,0,'L',0);
