<?php
  ...
  try {
    ...
    $pdf->SetFont('Arial','',13);
  	...
  	$pdf->Cell(280,1,'REPORTE DE MEDICAMENTOS',0,0,'C',0);

  	$pdf->Ln(10);
    $pdf->SetX(5);
  	$pdf->SetFont('Arial','B',8);
  	$pdf->Cell(10,5,'#',1,0,'C',0);
    $pdf->Cell(45,5,utf8_decode('TIPO'),1,0,'C',0);
  	$pdf->Cell(120,5,utf8_decode('MEDICAMENTO'),1,0,'C',0);
    ...
    $pdf->Cell(17,5,'ESTADO',1,0,'C',0);
      ...
      $pdf->SetX(5);
  		...
  		$pdf->Cell(45,5,utf8_decode($key['name_tipo']),1,0,'C',0);
      $pdf->Cell(120,5,utf8_decode($key['name_medicamento']),1,0,'L',0);
