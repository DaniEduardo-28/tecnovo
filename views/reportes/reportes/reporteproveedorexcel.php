...
try {
    ...
    $Resultado = $OBJ_PROVEEDOR->showreporte("all", null, null);
    ...
    $filename = 'reporte_proveedores.xls';
    ...
    $excel_data = "NUM\tDOCUMENTO\tNOMBRE PROVEEDOR\tAPODO\tDIRECCION\tTELEFONO\tESTADO\n";
    ...
    foreach ($arrayresultado as $key) {
        $excel_data .= $x . "\t" .
            ...
            mb_convert_encoding($key['nombre_proveedor'], 'UTF-8', 'auto') . "\t" .
