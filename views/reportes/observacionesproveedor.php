...
<html>
  ...
  <head>
    ...
    <title>Observaciones de Proveedor | <?=APP_TITLE;?> </title>
    <style media="screen">
      .pagination {
  ...
  <body>
                              ...
                              <div class="card card-statistics">
                                <div class="card-header">
                                    <div class="card-heading">
                                        <h4 class="card-title">Observaciones de Proveedor</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row justify-content-center align-items-center">
                                          <div class="col-md-8 text-center">
                                            <div class="error-text">
                                              ...
                                              <p>Posiblemente no tiene ningún proveedor registrado con los parametros de busqueda</p>
                                            </div>
                                          </div>
                                        </div>
                                      </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="AddModalLabel">Agregar Observación</h5>
          ...
          <div class="modal-body">
            ...
            <div class="form-group col-xs-12">
              ...
              <input type="text" name="txtProveedor" id="txtProveedor" class="form-control" readonly>
            </div>
            <div class="form-group col-xs-12">
              <label for="txtObservacion">Observación</label>
              <textarea name="txtObservacion" id="txtObservacion" rows="8" cols="80"
                class="form-control"
              ></textarea>
            </div>
          </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <input type="hidden" name="id_proveedor" id="id_proveedor">
            <div class="form-group col-xs-12">
              <label for="txtProveedorVer">Proveedor</label>
              <input type="text" name="txtProveedorVer" id="txtProveedorVer" class="form-control" readonly>
            </div>
            <div class="form-group col-xs-12">
    ...
    <script src="resources/system/js/pages/reportes/observacionesproveedor.js?v=<?=APP_VERSION;?>"></script>
    <script>
      $("#menureportes").addClass('active');
      $("#submenuobservacionesproveedor").addClass('active');
    </script>
