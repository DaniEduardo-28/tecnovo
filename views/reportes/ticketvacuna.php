<?php
  ...
  require_once 'admin/resources/pdf/vendor/autoload.php';

  try {

    $id_mascota = isset($_GET["id_mascota"])	? $_GET["id_mascota"]	: "";

    require_once "admin/core/models/ClassEmpresa.php";
    ...
    require_once "admin/core/models/ClassMascotaVacuna.php";
    ...
    if ($_SESSION['id_cliente']!=$arraymascota[0]['id_cliente']) {
      throw new Exception("No tienes acceso para ver esta mascota.");
    }
    ...
    $html1 .= '<link rel="stylesheet" href="admin/views/operaciones/reportes/style.css" media="all" />';
    $html1 .= '</head>';
    $html1 .= '<body>';
    $html1 .= '<header class="clearfix">';
    $html1 .= '<div id="logo" style="width: 80px; height: 80px;">';
    $html1 .= '<img src="admin/' . $empresa[0]['src_logo'] . '">';
    $html1 .= '</div>';
    ...
    $html1 .= '<div class="email"><a href="' . $arraymascota[0]['correo'] . '">' . $arraymascota[0]['correo'] . '</a></div>';
    $html1 .= '</div>';
    $html1 .= '<div id="logo1" style="width: 120px; height: 100px;float: right;padding-left: 20px;">';
    $html1 .= '<img src="admin/' . $arraymascota[0]['src_imagen'] . '">';
    $html1 .= '</div>';
    $html1 .= '<div id="invoice">';
    ...
    $html1 .= '</tfoot>';
    $html1 .= '</table>';
    $html1 .= '<div id="thanks">Gracias!</div>';
