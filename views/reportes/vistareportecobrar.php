...
<body>
              ...
              <div class="col-md-12 m-b-30">
                <div class="d-block d-lg-flex flex-nowrap align-items-center">
                  ...
                  <div class="ml-auto align-items-center secondary-menu text-center" id="panelOptions"
                    name="panelOptions">
                    <?php
                    $access_options = $OBJ_ACCESO_OPCION->getPermitsOptions($_SESSION['id_grupo'], printCodeOption("vistareportecobrar"));
                ...
                <div class="card card-statistics">
                  <div class="card-header">
                    <div class="card-heading">
                      <h4 class="card-title">Clientes por Cobrar</h4>
                    </div>
                  </div>
                  <div class="card-body">
  ...
  <script src="resources/system/js/pages/reportes/vistareportecobrar.js?v=<?= APP_VERSION; ?>"></script>
  <script>
    $("#menureportes").addClass('active');
    $("#submenureportecobrar").addClass('active');
  </script>
