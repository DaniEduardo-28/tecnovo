...
<html>
  ...
  <head>
    ...
    <title>Reporte Ordenes de Compra | <?=APP_TITLE;?> </title>
    <style media="screen">
      .pagination {
  ...
  <body>
                              ...
                              <div class="card card-statistics">
                                <div class="card-header">
                                    <div class="card-heading">
                                        <h4 class="card-title">Reporte Ordenes de Compra</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="col-md-12" id="panelTabla">
                                      ...
                                      <div class="row">
                                        <div class="form-group col-md-3 col-sm-6">
                                          <label for="cboTipoDocCompraBuscar" class="label-control">Documento de Compra</label>
                                          <select name="cboTipoDocCompraBuscar" id="cboTipoDocCompraBuscar" class="form-control">
                                        ...
                                        <div class="form-group col-md-3 col-sm-6">
                                          <label for="cboTipoDocuProBuscar">Documento de Proveedor</label>
                                          <select class="form-control" id="cboTipoDocuProBuscar" name="cboTipoDocuProBuscar">
                                            <option value="">Todos</option>
                                            <?php
    ...
    <script src="resources/system/js/pages/reportes/vistareporteordencompra.js?v=<?=APP_VERSION;?>"></script>
    <script>
      $("#menureportes").addClass('active');
      $("#submenureporteordencompra").addClass('active');
    </script>
