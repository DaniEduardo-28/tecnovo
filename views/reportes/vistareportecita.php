...
<head>
  ...
  <title>Reporte cita | <?= APP_TITLE; ?> </title>
  <style media="screen">
    .pagination {
...
<body>
  ...
  <script src="resources/system/js/pages/reportes/vistareportecita.js?v=<?= APP_VERSION; ?>"></script>
  <script>
    $("#menureportes").addClass('active');
    $("#submenureportecita").addClass('active');
  </script>
