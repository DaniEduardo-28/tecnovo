...
<body>
                          ...
                          <form id="frmDatos" name="frmDatos" enctype="multipart/form-data">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-sm-4">
                                <img id="img_destino" src="resources/global/images/sin_imagen.png" alt="Imagen Servicio"
                              ...
                              <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-xs-12">
                                  ...
                                  <select name="id_tipo_servicio" id="id_tipo_servicio" class="form-control" required>
                                    ...
                                    $dataTipoServicio = $OBJ_TIPO_SERVICIO->show("activo");
                                    if ($dataTipoServicio["error"] == "NO") {
                                      foreach ($dataTipoServicio["data"] as $key) {
                                ...
                                <div class="form-group col-xs-12">
                                  <label for="name_servicio" class="label-control">Servicio</label>
                                  <input id="name_servicio" type="text" name="name_servicio" class="form-control"
                                ...
                                <div class="form-group col-xs-12">
                                  <label for="id_maquinaria" class="label-control">Maquinaria Dirigida</label>
                                  <select name="id_maquinaria" id="id_maquinaria" class="form-control" required>
                                    <option value="">Seleccione...</option>
                                    <?php
                                    include("core/models/ClassServicio.php");
                                    $dataMaquina = $OBJ_SERVICIO->showMaquinas("activo");
                                    if ($dataMaquina["error"] == "NO" && !empty($dataMaquina["data"])) {
                                      foreach ($dataMaquina["data"] as $key) {
                                        echo '<option value="' . $key['id_maquinaria'] . '">' . $key['maquinaria_descripcion'] . '</option>';
                                      }
                                    } else {
                                      echo '<option value="">No hay maquinarias activas</option>';
                                    }
                                    ?>
                                  </select>
                                </div>
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-md-12 col-sm-12">
                                <label for="descripcion_larga" class="label-control">Descripción u Observaciones</label>
                                <input id="descripcion_larga" type="text" name="descripcion_larga" class="form-control"
                              ...
                              <div class="form-group col-md-3 col-sm-4 d-none">
                                <label for="">&nbsp;</label>
                                <div class="form-check">
                                  <input id="flag_igv" name="flag_igv" type="checkbox" class="form-check-input"
                                    checked="">
                          ...
                          <div class="col-md-4 col-sm-4">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="cboTipoBuscar" id="cboTipoBuscar">
                                ...
                                <?php
                                $dataTipoServicio = $OBJ_TIPO_SERVICIO->show("all");
                                if ($dataTipoServicio["error"] == "NO") {
                                  foreach ($dataTipoServicio["data"] as $key) {
                                    echo '<option value="' . $key['id_tipo_servicio'] . '">' . $key['name_tipo'] . '</option>';
                                  }
                            ...
                            <div class="col-md-8 text-center">
                              <div class="error-text">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                  ...
                                  viewBox="0 0 398.1 226.6" style="enable-background:new 0 0 398.1 226.6;"
                                  xml:space="preserve">
                                  <g id="OBJECTS">
                                    <g>
                                      <path class="st0"
                                      ...
                                      <ellipse transform="matrix(0.9914 0.1307 -0.1307 0.9914 28.4406 -25.947)"
                                        class="st5" cx="211.9" cy="203.7" rx="11.2" ry="6.3"></ellipse>
                                      <g>
                                      ...
                                      <g>
                                        ...
                                        <ellipse transform="matrix(0.8917 -0.4527 0.4527 0.8917 -64.7638 91.5674)"
                                          class="st5" cx="158.9" cy="181.1" rx="15.7" ry="7"></ellipse>
                                        <path class="st11"
                                      ...
                                      <g>
                                        ...
                                        <ellipse transform="matrix(0.8479 0.5301 -0.5301 0.8479 134.9254 -109.8333)"
                                          class="st5" cx="258.9" cy="180.2" rx="10.6" ry="4.7"></ellipse>
                                        <path class="st11"
  ...
  <script src="resources/system/js/pages/mantenimiento/servicio.js?v=<?= APP_VERSION; ?>"></script>
  <script>
