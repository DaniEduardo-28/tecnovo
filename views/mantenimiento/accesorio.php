...
<head>
  ...
  <style>
    ...
    .ocultar-precio-venta th:nth-child(7),
    /* Encabezado de la columna */
    .ocultar-precio-venta td:nth-child(7)
...
<body>
                      ...
                      <div class="col-md-12" id="panelForm"> <!-- d-none -->
                        <div class="ser-block block">
                          <form id="frmDatos" name="frmDatos" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="id_accesorio" id="id_accesorio" value="0">
                            ...
                            <div class="row">
                              ...
                              <div class="form-group col-sm-4">
                                <img id="img_destino" src="resources/global/images/sin_imagen.png" alt="Imagen Producto"
                              ...
                              <div class="form-group col-sm-6">
                                ...
                                <div class="form-group col-xs-12">
                                  ...
                                  <select name="id_categoria" id="id_categoria" class="form-control" required>
                                    ...
                                    <?php
                                    include("core/models/ClassCategoriaAccesorio.php");
                                    $dataCategoriaAccesorio = $OBJ_CATEGORIA_ACCESORIO->show("activo");
                                    if ($dataCategoriaAccesorio["error"] == "NO") {
                                      foreach ($dataCategoriaAccesorio["data"] as $key) {
                                        echo '<option value="' . $key['id_categoria'] . '">' . $key['name_categoria'] . '</option>';
                                      }
                                    }
                                    ?>
                                  </select>
                              ...
                              <div class="form-group col-md-3 col-sm-4 d-none">
                                ...
                                <div class="form-check">
                                  <input id="flag_consumo" name="flag_consumo" type="checkbox" class="form-check-input"
                                    checked="">
                                  <label for="flag_consumo" class="form-check-label">¿Es un producto Consumible?</label>
                                </div>
                              </div>
                          ...
                          <div class="col-md-4 col-sm-4">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="cboCategoriaBuscar" id="cboCategoriaBuscar">
                                ...
                                <?php
                                $dataCategoriaAccesorio = $OBJ_CATEGORIA_ACCESORIO->show("all");
                                if ($dataCategoriaAccesorio["error"] == "NO") {
                                  foreach ($dataCategoriaAccesorio["data"] as $key) {
                                    echo '<option value="' . $key['id_categoria'] . '">' . $key['name_categoria'] . '</option>';
                                  }
  ...
  <script src="resources/system/js/pages/mantenimiento/accesorio.js?v=<?= APP_VERSION; ?>"></script>
  <script>
    $("#menumantenimiento").addClass('active');
    $("#menuaccesorio").addClass('active');
  </script>
