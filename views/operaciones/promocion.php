...
<html>
  ...
  <head>
    ...
    <title>Promociones del Cliente | <?=APP_TITLE;?> </title>
    <style media="screen">
      .pagination {
  ...
  <body>
                              ...
                              <div class="card card-statistics">
                                <div class="card-header">
                                    <div class="card-heading">
                                        <h4 class="card-title">Promociones del Cliente</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                      ...
                                      <div class="row">
                                        <div class="col-md-4 col-sm-4">
                                          <div class="form-group">
                                            <label for="cboTipoBuscar" class="label-control">Tipo de Documento</label>
                                            <select class="form-control" name="cboTipoBuscar" id="cboTipoBuscar">
                                              <option value="">Todos...</option>
                                              <?php
                                                include("core/models/ClassDocumentoIdentidad.php");
                                                $dataDocumentoIdentidad = $OBJ_DOCUMENTO_IDENTIDAD->show("all");
                                                if ($dataDocumentoIdentidad["error"]=="NO") {
                                                  foreach ($dataDocumentoIdentidad["data"] as $key) {
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="AddModalLabel">Agregar Promoción</h5>
                ...
                <form id="frmDatos" name="frmDatos" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-sm-10">
                      ...
                      alt="Imagen Promoción" class="img-fluid"
                      style="width:370px;height:340px;">
                      <br>
                      <label for="">Imagen Promoción</label>
                      <br>
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-xs-12">
                      <label for="txtCliente" class="label-control">Cliente</label>
                      <input id="txtCliente" type="text" name="txtCliente" class="form-control"
                      autocomplete="off" readonly data-msg="Campo obligatorio...">
                    </div>
                    ...
                    <div class="form-group col-xs-12">
                      ...
                      <textarea name="descripcion" id="descripcion" rows="5" cols="80"
                        class="form-control"
                      ></textarea>
                    </div>

                    <div class="form-group col-sm-6">
                      <label for="fecha_inicio" class="label-control">Fecha Inicio</label>
                      <input id="fecha_inicio" type="date" name="fecha_inicio" class="form-control"
                      autocomplete="off" required value="<?=date('Y-m-d');?>">
                    </div>

                    <div class="form-group col-sm-6">
                      <label for="fecha_fin" class="label-control">Fecha Fin</label>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <button type="reset" name="btnCancel" id="btnCancel" name="button" data-dismiss="modal"
    ...
    <div class="modal fade bd-example-modal-lg" id="showModal" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="showModalLabel">Observaciones</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <div class="form-group col-xs-12">
              <label for="txtClienteVer">Cliente</label>
              <input type="text" name="txtClienteVer" id="txtClienteVer" class="form-control" readonly>
            </div>
            <div class="form-group col-xs-12">
    ...
    <script src="resources/system/js/pages/operaciones/promocion.js?v=<?=APP_VERSION;?>"></script>
    <script>
      $("#menureportes").addClass('active');
      $("#submenupromocion").addClass('active');
    </script>
